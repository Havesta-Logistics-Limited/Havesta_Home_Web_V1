      ...
      mt-12 bg-[url('https://res.cloudinary.com/dtc89xi2r/image/upload/v1719273258/Group_1000001819_1_elh4s0.png')] p-10">
        ...
        <div className="lg:grid grid-flow-col justify-items-center items-center space-y-4 lg:p-10 ">
          {joinUs.map((item, index) => (
            <>
             <div className="bg-white relative grid grid-flow-col lg:grid-flow-row justify-items-center items-center rounded-xl w-[300px] mx-auto" key={index}>
              <div className="z-10 w-full">
                <img
                 src={item.image}
                  className="w-[200px] h-[180px] lg:w-[328px] m-2 lg:m-0 object-cover rounded-lg"
                   />
              </div>
              ...
              <div className="grid grid-flow-row ml-2 lg:ml-0">
                ...
                <button
                className="text-[10px] bg-primary rounded-3xl p-2 hover:bg-primaryHover cursor-pointer text-white lg:text-xs  lg:w-40 m-4"
                >{item.button}</button>
              </div>
             </div>
            </>
