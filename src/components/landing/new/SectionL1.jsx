                        ...
                        <div className="flex gap-[21.23px] flex-col">
                            <div className="flex gap-[14.16px] flex-col">
                                ...
                                <p className="text-[14.16px] max-w-[552.07px] leading-[25px] font-[400] ">
                                    At Harvesta, we believe that everyone
                                    deserves access to the freshest farm
                                    produce, right at their doorstep. Our
                                    mission is to bridge the gap between local
                                    farmers and busy customers, ensuring that
                                    the highest quality fruits, vegetables, and
                                    other farm-fresh products are just a click
                                    away.
                                </p>
                            </div>
