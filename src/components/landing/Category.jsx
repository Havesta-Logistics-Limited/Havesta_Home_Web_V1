    ...
    <section className="  grid grid-flow-col justify-items-around items-center box-border mx-[120px]">
      ...
      <div className="grid grid-flow-row justify-items-center">
        ...
        <p className="text-[15px] text-center text-wrap w-[400px]">
          Get fresh farm produce delivered in minutes from a variety of trusted
          vendors offering fruits, veggies, tubers, grains, and nuts.
        </p>
        ...
        <img src="https://res.cloudinary.com/dtc89xi2r/image/upload/v1721823608/Group_1000001793_qvhqd7.png" alt="" className="w-[600px]" />
